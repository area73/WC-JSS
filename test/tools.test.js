...
test('test mediaQuery not mediaType ', () =>{
  let mqObj = {selector: '.responsive:before', mediaType:'screen', upTo:'tablet', invert:true};
  let mixins = [`content: "will not apply to screen";`];
