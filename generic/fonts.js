...
const fontFace = (fontFace) => {
  const fontFaceGroup = fontFace || JSS.generic.fonts.fontFace;
  return fontFaceGroup.reduce( (prev,next) => prev + `
      @font-face {
...
const fontFamily = `
  ${JSS.generic.fonts.rootEl || JSS.globalRoot} { font-family: ${JSS.generic.fonts.globalFontFamily} !important; }
`;
